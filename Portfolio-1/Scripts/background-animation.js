...
class DownloadManager {
  ...
  showInitialProgress() {
    this.showProgress();
    this.simulateInitialDownloadProgress();
  }

  async simulateInitialDownloadProgress() {
    const steps = [
      ...
      { progress: 100, text: "Download completed successfully!" },
    ];
    ...
    // After the initial progress, you can hide the overlay or keep it for the actual download
    setTimeout(() => {
      this.hideProgress();
