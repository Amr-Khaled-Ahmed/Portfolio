  ...
  const handleCommand = (cmd: string) => {
    ...
    switch (trimmedCmd.toLowerCase()) {
      ...
      case "ls":
        ...
        newOutput.push({
          text: "  certifications.npz  [ENCRYPTED]",
          type: "ctf",
        });
        newOutput.push({
          text: "  skills.npz          [ENCRYPTED]",
          type: "ctf",
        });
        newOutput.push({
          text: "  writeups.npz        [ENCRYPTED]",
          type: "ctf",
        });
        newOutput.push({
          text: "  projects.npz        [ENCRYPTED]",
          type: "ctf",
        });
        newOutput.push({
          text: "  contact.npz         [ENCRYPTED]",
          type: "ctf",
        });
        newOutput.push({ text: "", type: "system" });
        setOutput(newOutput);
      ...
      case "ls -la":
        ...
        newOutput.push({
          text: "drwx------   7 root root 4.0K Feb  1 00:00 .",
          type: "output",
        });
        newOutput.push({
          text: "drwxr-xr-x  18 root root 4.0K Feb  1 00:00 ..",
          type: "output",
        });
        newOutput.push({
          text: "-rwxr-xr-x   1 root root  12K Feb  1 00:00 certifications.npz",
          type: "ctf",
        });
        newOutput.push({
          text: "-rwxr-xr-x   1 root root  8.2K Feb  1 00:00 skills.npz",
          type: "ctf",
        });
        newOutput.push({
          text: "-rwxr-xr-x   1 root root  12K Feb  1 00:00 writeups.npz",
          type: "ctf",
        });
        newOutput.push({
          text: "-rwxr-xr-x   1 root root  16K Feb  1 00:00 projects.npz",
          type: "ctf",
        });
        newOutput.push({
          text: "-rwxr-xr-x   1 root root  2.0K Feb  1 00:00 contact.npz",
          type: "ctf",
        });
        newOutput.push({ text: "", type: "system" });
        setOutput(newOutput);
      ...
      case "sysinfo":
        ...
        newOutput.push({ text: "", type: "system" });
        newOutput.push({
          text: "💻 OS: ZeroAccessOS 11.0 (ZeroAccess Edition)",
          type: "output",
        });
        newOutput.push({
          text: "⚙️  Kernel: 5.19.0-pwn-generic",
          type: "output",
        });
        newOutput.push({
          text: "🐚 Shell: ZeroAccess Z-Shell 7.2",
          type: "output",
        });
        newOutput.push({ text: "⏱️  Uptime: 47d 12h 33m", type: "output" });
        newOutput.push({
          text: "🔒 Security: Maximum (Hacker Mode Active)",
          type: "warning",
        });
        newOutput.push({ text: "", type: "system" });
        setOutput(newOutput);
      ...
      case "neofetch":
        ...
        newOutput.push({
          text: "       OS: ZeroAccessOS 11.0 ZeroAccess",
          type: "output",
        });
        newOutput.push({
          text: "       Host: Cyber War Machine",
          type: "output",
        });
        newOutput.push({
          text: "       Kernel: 5.19.0-pwn-generic",
          type: "output",
        });
        newOutput.push({
          text: "       Shell: zsh 7.2 (ZeroAccess)",
          type: "output",
        });
        newOutput.push({
          text: "       CPU: Intel i9-13900K (24) @ 5.8GHz",
          type: "output",
        });
        newOutput.push({
      ...
      case "pulse":
        ...
        newOutput.push({
          text: heartbeat
            ...
            : "Heartbeat monitor activated...",
          type: heartbeat ? "info" : "ctf",
        });
        newOutput.push({ text: "", type: "system" });
        setOutput(newOutput);
        break;
      ...
      case "hackermode":
        newOutput.push({
          text: "⚠️  WARNING: ACTIVATING HACKER MODE",
          type: "warning",
        });
        newOutput.push({
          text: "Unlocking ultimate privileges...",
          type: "ctf",
        });
      ...
      case "pharaoh":
        ...
        newOutput.push({
          text: "• Code is law, but exploits are poetry",
          type: "output",
        });
        newOutput.push({
          text: "• Every lock has a key, every system has a flaw",
          type: "output",
        });
        newOutput.push({ text: "", type: "system" });
        setOutput(newOutput);
      ...
      case "decrypt":
        newOutput.push({
          text: "🔓 INITIATING DECRYPTION SEQUENCE",
          type: "ctf",
        });
        newOutput.push({ text: "Analyzing cipher patterns...", type: "info" });
        newOutput.push({
          text: "Pattern detected: Alphabet shift",
          type: "warning",
        });
        newOutput.push({
          text: "Try different values between 1-25",
          type: "info",
        });
        newOutput.push({ text: "", type: "system" });
        setOutput(newOutput);
      ...
      case "ctf":
        ...
        newOutput.push({ text: "", type: "system" });
        newOutput.push({
          text: "🎯 Challenge: Decode the Secret",
          type: "ctf",
        });
      ...
      case "hint":
        ...
        newOutput.push({ text: "", type: "system" });
        newOutput.push({
          text: "I move forward, yet stay in place,",
          type: "output",
        });
        newOutput.push({
          text: "Through letters, I slowly race.",
          type: "output",
        });
        newOutput.push({
      ...
      default:
        if (trimmedCmd.toLowerCase().startsWith("submit ")) {
          ...
          if (checkFlag(submittedFlag)) {
            ...
            newOutput.push({
              text: "𓂀 You have mastered the Pharaoh's challenge! 𓂀",
              type: "ctf",
            });
            newOutput.push({ text: "", type: "system" });
            newOutput.push({
              text: "🏆 Flag: Snow{w1nter_is_c0m1n9}",
              type: "success",
            });
            newOutput.push({ text: "", type: "system" });
            setCtfSolved(true);
            ...
            <div key={index} className="mb-1">
              {item.text.startsWith("root@ZeroAccess") ? (
                <div className="flex items-start">
                  ...
                  <span className="text-white">$ </span>
                  <span
                    className={`${getOutputColor(item.type)} ml-1 break-all`}
                  >
