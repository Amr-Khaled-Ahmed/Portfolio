  ...
  const projects: Project[] = [
    {
      ...
      technologies: ["Python", "Bash", "Nmap", "SQLmap", "Custom Scripts", 'PowerShell','C++','C'],
      category: "tools",
      icon: "fas fa-toolbox",
    ...
    },
    {
      ...
      technologies: ["HTML", "CSS", "JavaScript", "React", "TailWind", "BootStrap"],
      category: "webdev",
      icon: "fas fa-laptop-code",
    ...
    },
    {
      ...
      technologies: ["HTML", "CSS", "JavaScript", "Backend Framework","Django","SQLite"],
      category: "webdev",
      icon: "fas fa-book",
    ...
    },
    {
      ...
      technologies: ["Web Development", "UI/UX Design","HTML", "CSS", "JavaScript"],
      category: "webdev",
      icon: "fas fa-laptop-code",
      demo: "https://yn0.org/",
      highlights: [
    ...
    },
    {
      ...
      technologies: [ "Mathematics", "Cryptography","QT"],
      category: "development",
      icon: "fas fa-calculator",
